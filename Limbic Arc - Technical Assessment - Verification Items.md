...
| V4 | Fluid API capabilities — hosted card capture, subscription events, and 2-way sync. | §8.2 guardrails / §12 Phase 3 | Gate the Payments & Subscriptions extraction design. |
| V5 | Subscription volume split between Exigo and Fluid (which subscriptions, and what % of volume/revenue each holds). | §12 Phase 3 (migration plan) | Size and sequence the subscription migration. |
